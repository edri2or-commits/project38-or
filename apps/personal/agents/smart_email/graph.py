...
from apps.personal.agents.gmail_client import GmailClient
from apps.personal.agents.smart_email.nodes.classify import classify_emails_node
from apps.personal.agents.smart_email.nodes.draft import draft_node
from apps.personal.agents.smart_email.nodes.format_rtl import format_telegram_node
from apps.personal.agents.smart_email.nodes.history import history_node
from apps.personal.agents.smart_email.nodes.memory import memory_enrich_node, memory_record_node
from apps.personal.agents.smart_email.nodes.research import research_node
from apps.personal.agents.smart_email.nodes.verify import verify_completeness_node
from apps.personal.agents.smart_email.state import EmailState, create_initial_state
...
async def send_telegram_node(state: EmailState) -> EmailState:
    ...
    try:
        ...
        if not token or not chat_id:
            ...
            try:
                from libs.shared_core.secrets import SecretManager
...
async def run_smart_email_agent(
    ...
    Example:
        import asyncio
        from apps.personal.agents.smart_email import run_smart_email_agent
