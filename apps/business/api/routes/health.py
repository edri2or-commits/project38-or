...
from apps.business.api.database import check_database_connection
...
async def mcp_gateway_status() -> dict:
    ...
    try:
        ...
        from apps.business.api.main import app as main_app
...
async def mcp_test() -> dict:
    ...
    try:
        from apps.business.mcp_gateway.server import create_mcp_server
...
async def relay_status() -> dict:
    ...
    from apps.business.api.main import get_github_relay, get_relay_startup_error
