...
Example:
    >>> from apps.business.core.multi_agent.monitoring_agent import MonitoringAgent
    >>>
...
if TYPE_CHECKING:
    from apps.business.core.alert_manager import AlertManager
    ...
    async def _handle_check_anomalies(self, task: AgentTask) -> AgentResult:
        ...
        try:
            ...
            if self.anomaly_detector:
                from apps.business.core.ml_anomaly_detector import DataPoint
    ...
    async def _handle_send_alert(self, task: AgentTask) -> AgentResult:
        ...
        try:
            ...
            if self.alert_manager:
                from apps.business.core.alert_manager import Alert, AlertSeverity
